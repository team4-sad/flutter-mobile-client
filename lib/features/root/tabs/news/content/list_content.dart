  ...
  Widget build(BuildContext context) {
    return BlocBuilder<NewsListBloc, NewsListState>(
      ...
      builder: (context, state) {
        if (state is WithDataState<NewsModel> && (state as WithDataState<NewsModel>).hasNotEmptyData) {
        ...
        } else if (state is WithDataState<NewsModel> && (state as WithDataState<NewsModel>).hasEmptyData) {
