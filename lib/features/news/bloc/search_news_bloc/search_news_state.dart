...
final class NewsSearchLoading extends WithSearchResult
    implements NewsSearchState, PaginationLoadingState<NewsModel> {
...
final class NewsSearchError extends WithSearchResult
    implements NewsSearchState, PaginationErrorState<NewsModel> {
